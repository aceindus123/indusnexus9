<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/NexusAdminMpage.master" AutoEventWireup="true" CodeFile="AdminCpc.aspx.cs" Inherits="Admin_AdminCpc" %>
...
<br /><asp:Label ID="Label1" CssClass="lbHeading" runat="server" Text="CPC Users Details"></asp:Label></td>
</tr><tr><td align="left">
...
<table align="left" width="400px"><tr><td>
...
onclick="btnaddnew_Click" /></td></tr><tr><td align="center"><br />
...
OnPageIndexChanging="grid1_PageIndexChanging" CellPadding="4" 
BackColor="White" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Width="990px" 
OnRowDeleting="gvd_RowDeleting"  >             
