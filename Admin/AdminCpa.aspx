<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/NexusAdminMpage.master" AutoEventWireup="true" CodeFile="AdminCpa.aspx.cs" Inherits="Admin_AdminCpa" %>
...
<asp:Label ID="Label1" CssClass="lbHeading" runat="server" Text="CPA Users Details"></asp:Label></td></tr>
<tr><td align="left"><asp:TextBox ID="txtSearch" runat="server" Width="230px" Height="30px" ></asp:TextBox>
...
<tr><td align="right"> <br /><table align="left" width="400px"><tr>
<td><asp:LinkButton ID="lnkwaiting" runat="server" Text="Waiting" CssClass="stslinks" 
...
<asp:GridView ID="GridView1" runat="server" DataKeyNames="Uid" AutoGenerateColumns="false"
AllowPaging="true" PageSize="10"   EmptyDataRowStyle-ForeColor="Red"
OnPageIndexChanging="grid1_PageIndexChanging"  BackColor="White" CellPadding="4"
BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Width="990px" OnRowDeleting="gvd_RowDeleting">             
...
<Columns>
<asp:TemplateField HeaderText="Id" ><ItemTemplate><asp:Label ID="lblid" runat="server" Text='<%#Eval("Uid") %>'></asp:Label>
